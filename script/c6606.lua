...
function s.ccond(e)
    ...
    --Debug.Message(e:IsActiveType(TYPE_PENDULUM))
    --Debug.Message(c:GetReason())
    --Debug.Message(c:GetReason()==0)
    --Debug.Message(c:IsReason(REASON_SPSUMMON))
    --Debug.Message(e:IsActiveType(TYPE_SPELL+TYPE_PENDULUM))
    --Debug.Message(Duel.MoveToField(c,tp,tp,LOCATION_SZONE,POS_FACEUP,true)==true)
    --Debug.Message(c:IsActivated())
