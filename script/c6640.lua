...
function s.montarget(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    --Duel.SetOperationInfo(0,CATEGORY_FIEL, targets, count, target_player, target_param)
...
function s.cfilter2(c)
    return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsOriginalType(TYPE_MONSTER) and c:IsLevel(7)
end
